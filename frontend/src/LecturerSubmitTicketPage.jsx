  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-950 font-sans text-slate-100 antialiased">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        <h1 className="font-heading mb-6 border-b border-cyan-500/20 pb-4 text-3xl font-bold text-red-300">
          🚨 Report Issue
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <section className="rounded-2xl border border-cyan-500/20 bg-slate-900/80 p-5">
            <div className="space-y-3">
              <label className="grid items-center gap-2 sm:grid-cols-[170px_1fr]">
                ...
                <input required value={title} onChange={(e) => setTitle(e.target.value)} className="rounded-lg border border-slate-700 bg-slate-950 px-3 py-2" />
              </label>
              <label className="grid items-center gap-2 sm:grid-cols-[170px_1fr]">
          ...
          <section className="rounded-2xl border border-cyan-500/20 bg-slate-900/80 p-5">
            ...
            <textarea required rows={5} value={description} onChange={(e) => setDescription(e.target.value)} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2" />
          </section>
          ...
          <section className="rounded-2xl border border-cyan-500/20 bg-slate-900/80 p-5">
            ...
            >
              ...
              <br />or
              <br />
              <span className="mt-2 inline-block rounded-md bg-cyan-500 px-3 py-1.5 font-semibold text-slate-950">
                Choose File
              </span>
            </button>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button type="button" onClick={() => navigate("/student/maintenance")} className="rounded-xl border border-slate-600 px-8 py-3 font-semibold text-slate-200 hover:border-cyan-400">
              Cancel
            </button>
          </div>
        </form>
