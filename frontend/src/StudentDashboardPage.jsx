        ...
        <div className="mt-6 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-xl text-slate-400">
              Your student hub for spaces, notices, and account tools. Connect APIs later for
              live bookings and tickets.
            </p>
              ...
              {modal === "profile" && (
                <div className="space-y-4 text-sm text-slate-400">
                  <p>
                    ...
                    <span className="text-cyan-400">Student</span> role.
                  </p>
              ...
              {modal === "settings" && (
                <div className="space-y-4">
                  <p className="text-sm text-slate-400">
                    Demo controls only — wire these fields to your API when ready.
                  </p>
                  <StudentSettingsForm />
                </div>
              )}
